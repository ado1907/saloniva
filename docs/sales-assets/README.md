# Saloniva Satisa Hazirlik Dosyalari

Bu klasor Saloniva'yi hedef salonlara gostermek ve satis gorusmesini profesyonel ilerletmek icin hazirlandi.

## Dosyalar

- `demo-video-screen-flow.md`: 1 dakikalik demo videosunda hangi ekranlarin hangi sirayla gosterilecegi.
...
1. Demo verileri dolu bir Saloniva hesabi hazirla.
2. `demo-video-screen-flow.md` akisiyle kisa ekran videosu kaydet.
